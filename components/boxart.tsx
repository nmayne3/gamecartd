...
const BoxArt = ({
  ...
  return (
    <div className="group relative rounded-sm-md shadow-xl smooth-transition outline outline-0.5 outline-secondary w-fit h-fit object-contain hover:-outline-offset-2 hover:outline-2 hover:outline-accent-green">
      <Image
        src={`https://images.igdb.com/igdb/image/upload/t_cover_big_2x/${game.cover.image_id}.jpg`}
        width={game.cover.width}
        height={game.cover.height}
        alt="Movie Poster"
        className="peer rounded-sm-md"
