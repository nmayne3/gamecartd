...
const Searchbar = () => {
  ...
  return (
    <section className="">
      <div className="peer search-bar z-10 w-32 h-6 flex flex-row place-items-center rounded-full text-trimary bg-opacity-25 pointer-events-none bg-header-light-grey active:bg-white  focus-within:bg-white group-hover:bg-opacity-100">
        <input
      ...
      {resultingGames.length > 0 && (
        <div className="absolute mt-1 hidden peer-focus-within:block hover:block">
          <ul className="bg-[#678] divide-y text-xxs divide-dark-grey rounded-md capitalize overflow-hidden">
