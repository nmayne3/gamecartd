...
const Searchbar = () => {
  ...
  return (
    <section className="">
      {/** Search bar */}
      <div className="peer group/search search-bar z-10 w-32 h-6 flex flex-row place-items-center rounded-full text-trimary bg-opacity-25 pointer-events-none bg-header-light-grey active:bg-white group-active/search:bg-white focus-within:bg-white group-hover/search:bg-opacity-100 hover:bg-opacity-100">
        <input
          onChange={debounceResults}
          name="SearchField"
          type="text"
          id="search"
          className="w-full h-full pl-3 outline-none bg-transparent rounded-full pointer-events-auto  peer"
        />
        <FaMagnifyingGlass className="mr-2.5 ml-1 scale-[140%] fill-header-light-grey group-hover/search:fill-trimary peer-focus:fill-trimary">
          {" "}
        </FaMagnifyingGlass>
      </div>
      {/** Search Results */}
